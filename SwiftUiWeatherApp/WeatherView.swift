                ...
                VStack {
                   Image(systemName: getWeatherIcon(for: weatherVM.weatherCode))
                        ...
                        Text(getWeatherDescription(for: weatherVM.weatherCode))
                            .font(.largeTitle)
                        // Display temperature from the ViewModel
                        Text("\(Int(weatherVM.temperature))°F")
                            .font(.system(size: 150))
                            .fontWeight(.thin)
                        
                        Text("Wind is \(Int(weatherVM.windSpeed)) mph - feels like \(weatherVM.feelsLike, specifier: "%.0f")°F")
                            .font(.title2)
                            .padding(.bottom)
